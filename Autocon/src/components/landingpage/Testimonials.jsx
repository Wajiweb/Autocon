...
const testimonials = [
  ...
  { name: 'Yousuf A.', role: 'DeFi Developer',       q: 'AutoCon cut my contract deployment time from hours to seconds. The security audit caught an overflow bug I missed entirely.' },
  { name: 'Maria K.',  role: 'NFT Creator',           q: 'I launched my entire NFT collection without writing a single line of code. The MetaMask integration is seamless.' },
  { name: 'Zaid S.',   role: 'Blockchain Founder',    q: 'The AI assistant is genuinely helpful for understanding what each parameter does. Perfect for non-technical founders.' },
