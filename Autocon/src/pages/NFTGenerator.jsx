            ...
            <div className="animate-fade-in-up" style={{ marginBottom: '32px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '14px', marginBottom: '8px' }}>
                    <div style={{
                        ...
                        fontSize: '22px', boxShadow: '0 4px 20px rgba(139,92,246,0.3)'
                    }}>🎨</div>
                    <h1 style={{
                ...
                <form onSubmit={generateNFT}>
                    ...
                    <div style={{ marginBottom: '24px' }}>
                        ...
                        <div style={{
                            ...
                            border: `2px dashed ${uploadedFile ? 'rgba(16,185,129,0.3)' : 'var(--border-color)'}`,
                            background: uploadedFile ? 'rgba(16,185,129,0.03)' : 'var(--bg-input)',
                                ...
                                <label style={{ cursor: 'pointer', display: 'block' }}>
                                    ...
                                    {isUploading ? (
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', justifyContent: 'center' }}>
                                            <svg style={{ animation: 'spin-slow 1s linear infinite', width: 16, height: 16, color: 'var(--accent)' }} viewBox="0 0 24 24" fill="none">
